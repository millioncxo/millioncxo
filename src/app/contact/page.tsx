                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-muted-jade">hello@millioncxo.com</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <div className="text-ivory-silk font-semibold">Phone</div>
                        <div className="text-muted-jade">+1 (555) 123-4567</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-muted-jade">50+ countries served</div>
                      </div>
                    </div>
                  </div>
                </div>

          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Link href="https://calendly.com/millioncxo/loe-20x" target="_blank" rel="noopener noreferrer" className="text-muted-jade hover:text-golden-opal transition-colors"
                  onClick={() => {
